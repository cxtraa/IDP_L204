...
class StateMachine:
    ...
    def start_procedure(self) -> None:
        ...
        self.time_forwards = ticks_diff(end_time_forwards, start_time_forwards) * 1e-03
    ...
    def update(self) -> None:
        ...
        #       - Else if there is no parcel, increment i, then break
        #   - Else if we don't have time to go to the next intended pickup point then go home
